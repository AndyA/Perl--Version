...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Perl-Version> or 
L<MetaCPAN|http://www.metacpan.org/module/Perl::Version>:

=over 4

=item *	L<http://search.cpan.org/dist/Perl-Version>

=item *	L<http://www.metacpan.org/module/Perl::Version>
